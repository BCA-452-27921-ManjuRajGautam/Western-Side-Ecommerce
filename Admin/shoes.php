...
// Total shoes stock
$stock_q = "SELECT SUM(stock) as total FROM products WHERE category='shoes' AND status='active'";
...
// Total shoes products count
$count_q = "SELECT COUNT(*) as total FROM products WHERE category='shoes'";
$count_r  = mysqli_query($conn, $count_q);
$total_products = ($count_r) ? mysqli_fetch_assoc($count_r)['total'] : 0;

// --- ALL SHOES PRODUCTS ---
$products_q = "SELECT * FROM products WHERE category='shoes' ORDER BY id DESC";
...
<head>
    ...
    <title>Western-Side | Shoes Admin</title>
...
<div class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column mt-2">
        ...
        <a class="nav-link active" href="shoes.php">
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 style="color: #1e3c72; font-family: 'Delius Swash Caps', cursive;">
                    <i class="fa fa-soccer-ball-o"></i> Shoes Collection
                </h1>
                <p class="mb-0 text-muted">Manage all men's footwear inventory</p>
            </div>
    ...
    <div class="table-responsive">
        <div class="table-header d-flex justify-content-between align-items-center">
            <h4 style="color: #1e3c72; margin: 0;">
                <i class="fa fa-list mr-2"></i> Shoes Inventory
            </h4>
            <a href="add_product.php" class="btn btn-admin text-white">
                <i class="fa fa-plus"></i> Add New Shoe
            </a>
        </div>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8" class="text-center text-muted py-5">
                        <i class="fa fa-soccer-ball-o fa-3x mb-3 d-block"></i>
                        No Shoes found. <a href="add_product.php">Add one now</a>
                    </td>
                </tr>
            <?php endif; ?>
            </tbody>
