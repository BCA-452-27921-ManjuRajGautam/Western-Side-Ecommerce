...
// Total watch stock
$stock_q = "SELECT SUM(stock) as total FROM products WHERE category='watch' AND status='active'";
...
// Total watch products count
$count_q = "SELECT COUNT(*) as total FROM products WHERE category='watch'";
$count_r  = mysqli_query($conn, $count_q);
$total_products = ($count_r) ? mysqli_fetch_assoc($count_r)['total'] : 0;

// --- ALL WATCH PRODUCTS ---
$products_q = "SELECT * FROM products WHERE category='watch' ORDER BY id DESC";
...
<head>
    ...
    <title>Western-Side | Watches Admin</title>
    ...
    <style>
        ...
        .stat-stock   .stat-icon { background: linear-gradient(135deg, #4ecdc4, #44a08d); color: white; }
...
<div class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column mt-2">
        ...
        <a class="nav-link active" href="watches.php">
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 style="color: #1e3c72; font-family: 'Delius Swash Caps', cursive;">
                    <i class="fa fa-clock-o"></i> Watches Collection
                </h1>
                <p class="mb-0 text-muted">Manage all men's watches inventory</p>
            </div>
    ...
    <div class="table-responsive">
        <div class="table-header d-flex justify-content-between align-items-center">
            <h4 style="color: #1e3c72; margin: 0;">
                <i class="fa fa-list mr-2"></i> Watches Inventory
            </h4>
            <a href="add_product.php" class="btn btn-admin text-white">
                <i class="fa fa-plus"></i> Add New Watch
            </a>
        </div>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8" class="text-center text-muted py-5">
                        <i class="fa fa-clock-o fa-3x mb-3 d-block"></i>
                        No Watches found. <a href="add_product.php">Add one now</a>
                    </td>
                </tr>
            <?php endif; ?>
            </tbody>
